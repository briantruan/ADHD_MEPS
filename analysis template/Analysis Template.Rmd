...
author: "Katrina Hannett, Nitya Koduri, Brian Ruan, Simran Rajpal, Shikhar Shrestha, PhD"
date: "`r Sys.Date()`"
output: 
  html_document:
    toc: TRUE
...
![**Figure 1:** Flowchart showing the inclusion/exclusion criteria, and the numbers removed at each step.](analysis template/data_cleaning_flowchart.png)
...
knitr::include_graphics(here::here("analysis template/DAG.png"))
```
